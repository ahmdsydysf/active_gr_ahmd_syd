...
<link href="{{ asset('adminAsset/dist/css/AdminLTE.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <!--============================================ -->
    <link rel="stylesheet" href="{{ asset('adminAsset/plugins/css/data-table/bootstrap-table.css')}}">
    <link rel="stylesheet" href="{{ asset('adminAsset/plugins/css/data-table/bootstrap-editable.css')}}">
    @if(isset($canonical))
