...
@section('page_title' , 'تصنيف المعرض')
                        ...
                        <div class="col-sm-12">
                            <table id="example" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                         aria-label="التصنيف عربي: activate to sort column ascending">
                                        التصنيف عربي</th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                         aria-label="التصنيف انجليزي: activate to sort column ascending">
                                        التصنيف انجليزي</th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>{{$r->order}}</td>
                                    <td>
                                        <a href="{{ route('gallary_category.edit' , $r->id) }}" class="btn btn-primary">تعديل</a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{route('gallary_category.destroy' , $r->id)}}" method="post">
                                                        @csrf
                                                        @method('DELETE')
...
<a class="btn bg-olive btn-lg" href="{{ route('gallary_category.create') }}"><i class="fa fa-plus"></i>
اضافة
</a>
