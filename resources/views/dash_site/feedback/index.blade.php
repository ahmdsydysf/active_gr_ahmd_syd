...
@section('content')
        ...
        <div class="box">
            <div class="box-header">
              <h3 class="box-title" >التقييم </h3>
            <a href="{{ route('feedback.create') }}"  class="btn bg-olive btn-lg pull-right">اضافة <i class="fa fa-plus"></i>  </a>
           ...
           <thead>
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                colspan="1" aria-label="وقت التقييم: activate to sort column ascending">وقت
                                                التقييم
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1"
                                                ...
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td> <span class="thumbnail"
                                                            style="background-color: #00A65A;width='150px'"><img
                                                                src="{{ asset('uploads/feedback/' . $r->image) }}" alt=""
                                                                srcset=""></span> </td>
                                                    <td>{{ $r->name_ar }}</td>
                                                    <td>{{ $r->name_en }}</td>
                                                    <td>{{ $r->position_ar }}</td>
