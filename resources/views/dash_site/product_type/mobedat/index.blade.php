...
@section('page_title', 'مبيدات')

@section('content')
<div class="box-body">

    <a href="{{ route('mobedat_category.create') }}" class="btn bg-olive btn-lg pull-right">اضافة <i class="fa fa-plus"></i>
    </a>
                                        ...
                                        @if ($row->count() > 0)
                                            @foreach ($row as $r)
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>{{ $r->order }}</td>
                                                    <td>
                                                        <a href="{{ route('mobedat_category.edit', $r->id) }}"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form
                                                                        action="{{ route('mobedat_category.destroy', $r->id) }}"
                                                                        method="post">
                                                                        @csrf
                                                                        @method('DELETE')
