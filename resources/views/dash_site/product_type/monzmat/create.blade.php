...
<div class="box box-success">
    ...
    <!-- form start -->
    <form role="form" action="{{route('monzmat_category.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        {{method_field('POST')}}
      <div class="box-body">
        ...
        <div class="form-group">
            ...
            <textarea  name="description_en" id="editor" class="form-control" rows="3" placeholder="النص">{{old('description_en')}}</textarea>
        </div>
      ...
      <div class="box-footer">
        ...
        <a href="{{ route('monzmat_category.index') }}" class="btn btn-danger">رجوع</a>
      </div>
