                                ...
                                @if ($row->count() > 0)
                                    @foreach ( $row as $r )
                                            ...
                                            <tr role="row" class="odd">
                                                ...
                                                <td>{{$r->order}}</td>
                                                <td>
                                                    <a href="{{ route('asmeda_category.edit' , $r->id) }}" class="btn btn-primary">تعديل</a>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{route('asmeda_category.destroy' , $r->id)}}" method="post">
                                                                    @csrf
                                                                    @method('DELETE')
...
<a class="btn bg-olive btn-lg" href="{{ route('asmeda_category.create')  }}"><i class="fa fa-plus"></i>
اضافة
</a>
