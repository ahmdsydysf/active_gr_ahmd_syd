                        ...
                        <div class="col-sm-12">
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td>{{$r->desc_ar}}</td>
                                    <td>{{$r->desc_en}}</td>
                                    <td> <span class="thumbnail" style="background-color: #00A65A"><img src="{{asset('uploads/contracts/'.$r->image)}}" alt="" srcset="" width="200"></span> </td>
                                    <td>{{$r->active}}</td>
                                    <td>{{$r->order}}</td>
                                    <td>
                                        <a href="{{ route('contract.edit' , $r->id) }}" class="btn btn-primary">تعديل</a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{route('contract.destroy' , $r->id)}}" method="post">
                                                        @csrf
                                                        @method('DELETE')
...
<a class="btn bg-olive btn-lg" href="{{ route('contract.create') }}"><i class="fa fa-plus"></i>
اضافة
</a>
