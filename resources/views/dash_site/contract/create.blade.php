...
<div class="box box-success">
    ...
    <div class="box-header">
      <h3 class="box-title">اضافة عقد</h3>
    </div><!-- /.box-header -->
    <!-- form start -->
    <form role="form" action="{{route('contract.store')}}" method="POST" enctype="multipart/form-data">
      ...
      <div class="box-body">
        <div class="form-group">
            <img src="{{asset('uploads/contracts/default_1.jpg')}}" class="img-thumbnail image-preview" width="350px" height="250px" alt="" srcset="">
          <dp-fbi></dp-fbi>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <textarea  name="desc_ar" class="form-control" rows="3" placeholder="النص">{{old('desc_ar')}}</textarea>
        </div>
        @error('desc_ar')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
        <div class="form-group">
            ...
            <textarea  name="desc_en" class="form-control" rows="3" placeholder="النص">{{old('desc_en')}}</textarea>
        </div>
        @error('desc_en')
        <div class="alert alert-danger">{{ $message }}</div>
        @enderror
