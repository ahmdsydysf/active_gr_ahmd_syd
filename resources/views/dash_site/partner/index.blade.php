                        ...
                        <div class="col-sm-12">
                            <table id="example" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                         aria-label="الاسم انجليزي: activate to sort column ascending">الاسم انجليزي
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                        ...
                                        الوصف عربي</th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                         aria-label="لوجو: activate to sort column ascending">
                                        لوجو</th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                            ...
                            <tbody>
                                ...
                                <tr role="row" class="odd">
                                    ...
                                    <td> <span class="thumbnail" style="background-color: #00A65A"><img src="{{asset('uploads/partners/'.$r->logo)}}" alt="" srcset="" width="200"></span> </td>
                                    <td>{{$r->website}}</td>
                                    <td>{{$r->facebook}}</td>
                                    <td>{{$r->twitter}}</td>
                                    <td>{{$r->instgram}}</td>
                                    <td>{{$r->order}}</td>
                                    <td>
                                        <a href="{{ route('partner.edit' , $r->id) }}" class="btn btn-primary">تعديل</a>
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <form action="{{route('partner.destroy' , $r->id)}}" method="post">
                                                        @csrf
                                                        @method('DELETE')
...
<a class="btn bg-olive btn-lg" href="{{ route('partner.create') }}"><i class="fa fa-plus"></i>
اضافة
</a>
