...
<div class="box box-success">
    ...
    <div class="box-header">
      <h3 class="box-title">اضافة شريك</h3>
    </div><!-- /.box-header -->
    <!-- form start -->
    <form role="form" action="{{route('partner.store')}}" method="POST" enctype="multipart/form-data">
      ...
      <div class="box-body">
        <div class="form-group">
            <img src="{{asset('uploads/partners/default_1.png')}}" class="img-thumbnail image-preview" width="350px" height="250px" alt="" srcset="">
          <dp-fbi></dp-fbi>
        </div>
        <div class="form-group">
