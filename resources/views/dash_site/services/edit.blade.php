...
<div class="row">
    ...
    <div class="col-md-10">
        ...
        <form action="{{route('company-service.update',$row->id)}}"  method="post" enctype="multipart/form-data">
            ...
            @method('PUT')
              @csrf
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 text-center">
                    ...
                    <a href="{{route('company-service.index')}}" class="btn btn-danger">إلغاء</a>
                </div>
                </div>
