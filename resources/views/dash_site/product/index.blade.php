                            ...
                            <table id="example" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                        ...
                                        الصورة</th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                         aria-label="انجليزي PDF: activate to sort column ascending">
                                         انجليزي PDF</th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                         aria-label="عربي PDF: activate to sort column ascending">
                                         عربي PDF</th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                         aria-label="المصنع: activate to sort column ascending">
                                         المصنع</th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
                                         aria-label="الشريك: activate to sort column ascending">
                                         الشريك</th>
                                    <th class="sorting" tabindex="0" aria-controls="example1" rowspan="1" colspan="1"
...
<a class="btn bg-olive btn-lg" href="{{ route('product.create') }}"><i class="fa fa-plus"></i>
اضافة
</a>
